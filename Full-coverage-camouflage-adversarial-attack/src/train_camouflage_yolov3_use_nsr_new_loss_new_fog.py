...
with torch.autograd.set_detect_anomaly(True):
    ...
    def train(hyp, opt, device):
        ...
        saved_state_dict = torch.load('/data/zhoujw/2024.1.2_last_logs/epoch-9+dataset-DTN+ratio-true+night-4+day-0+sync-true+patchInitialWay-random+batch_size-16+lr-0.01+model-resnet50+loss_func-loss_midu+loss_content+loss_smooth+lamb-0.0001+D1-0.9+D2-0.1+T-0.0001+/model_nsr_s9_l19.pth')  # 原始的参数字典
