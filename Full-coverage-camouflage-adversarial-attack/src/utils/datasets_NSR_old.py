...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index): #一个魔术方法，定义了之后就可以直接class[index]获得想要的数据，也可以切片，
        ...
        color_ref_path=os.path.join("/data/zhoujw/upload_NSR/differentColor",self.color_name,filename)
