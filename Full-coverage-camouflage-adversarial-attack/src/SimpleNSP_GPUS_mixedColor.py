...
def train(device,hyp, opt,log_dir,logger):
    ...
    saved_state_dict = torch.load('/home/zhoujw/FCA/Full-coverage-camouflage-adversarial-attack/src/logs/epoch-9+dataset-DTN+ratio-false+night-4+day-0+sync-true+patchInitialWay-random+batch_size-16+lr-0.01+model-resnet50+loss_func-loss_midu+loss_content+loss_smooth+lamb-0.0001+D1-0.9+D2-0.1+T-0.0001+/model_nsr_s9_l7.pth')  # 原始的参数字典
    new_state_dict = {}
